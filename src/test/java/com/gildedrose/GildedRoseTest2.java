...
class GildedRoseTest2 {
    ...
    class AgedBrie {
        ...
        void agedBrieIncreasesInQuality() {
            ItemBrie2[] items = new ItemBrie2[]{new ItemBrie2(BRIE, 10, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
        ...
        void qualityNeverMoreThanFifty() {
            ItemBrie2[] items = new ItemBrie2[]{new ItemBrie2(BRIE, 10, 50)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
        ...
        void agedBrieQualityIncreasesDoubleAfterSellIn() {
            ItemBrie2[] items = new ItemBrie2[]{new ItemBrie2(BRIE, 0, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
        ...
        void agedBrieQualityNeverMoreThanFiftyEvenAfterSellIn() {
            ItemBrie2[] items = new ItemBrie2[]{new ItemBrie2(BRIE, 0, 49)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(50, app.items[0].quality);
        }
    ...
    class Sulfuras {
        ...
        void sulfurasQualityNeverChanges() {
            ItemSulfuras2[] items = new ItemSulfuras2[]{new ItemSulfuras2(SULFURAS, 10, 80)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
        ...
        void sulfurasNeverChangesEvenAfterSellIn() {
            ItemSulfuras2[] items = new ItemSulfuras2[]{new ItemSulfuras2(SULFURAS, -1, 80)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(-1, app.items[0].sellIn);
            assertEquals(80, app.items[0].quality);
    ...
    class BackstagePasses {
        ...
        void increasesByOneMoreThanTenDays() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 11, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(21, app.items[0].quality);
        }
        ...
        void increasesByTwoWithTenDaysLeft() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 10, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(22, app.items[0].quality);
        }
        ...
        void increasesByTwoWithSixDaysLeft() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 6, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(22, app.items[0].quality);
        }
        ...
        void increasesByThreeWithFiveDaysLeft() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 5, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
        ...
        void increasesByThreeWithOneDayLeft() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 1, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(23, app.items[0].quality);
        }
        ...
        void qualityDropsToZeroAfterConcert() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 0, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(0, app.items[0].quality);
        }
        ...
        void qualityNeverMoreThanFiftyNearConcert() {
            ItemBackstage2[] items = new ItemBackstage2[]{new ItemBackstage2(BACKSTAGE_PASSES, 10, 49)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(50, app.items[0].quality);
        }
    ...
    class ConjuredItems {
        ...
        void conjuredItemsDegradeTwiceAsFast() {
            ItemConjured2[] items = new ItemConjured2[]{new ItemConjured2(CONJURED, 10, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
            assertEquals(18, app.items[0].quality);
            assertEquals(9,  app.items[0].sellIn);
        ...
        void conjuredItemsDegradeTwiceAsFastAfterSellIn() {
            ItemConjured2[] items = new ItemConjured2[]{new ItemConjured2(CONJURED, 0, 20)};
            GildedRose2 app = new GildedRose2(items);
            app.updateQuality();
